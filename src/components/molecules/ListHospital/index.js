...
const ListHospital = () => {
    return (
        <View style={styles.container}>
           ...
           <Text style={styles.title}>Cipto Mangunkusumo</Text>
...
const styles = StyleSheet.create({
    container:{
        flexDirection:'row',padding:16,borderBottomWidth:1,borderBottomColor:colors.border
    },
    picture:{
        width:80,
        height:60,
    ...
    title:{
        fontSize:16, fontFamily:fonts.primary.normal,color:colors.text.primary
    },
    address:{
